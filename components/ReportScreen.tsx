    ...
    <div className="w-full max-w-5xl animate-fade-in pb-10 print:pb-0">
      <style>{`
        @media print {
          ...
          /* Ajuste da Capa e Seções para A4 Real */
          .report-cover, .report-section { 
            width: 210mm;
            min-height: 297mm;
            padding: 35mm 25mm 25mm 35mm; /* Margens generosas (ABNT Style) */
            position: relative;
            background: white !important;
        ...
        .report-content p { line-height: 1.8; margin-bottom: 1.25rem; }
        
        /* Ajuste fino para a etiqueta não encostar na borda */
        .absolute.-top-5 { top: -1.25rem; }
      `}</style>
