    ...
    <div className="w-full max-w-5xl animate-fade-in pb-10 print:pb-0 print:max-w-none">
      <style>{`
        @media print {
          ...
          .report-page { page-break-after: always !important; box-shadow: none !important; border: none !important; }
        }
      `}</style>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mt-12 no-print px-6 gap-6">
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
          <button onClick={onReview} className="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-2xl font-bold shadow-lg transition-all">
            Revisar Dados
          </button>
          <button onClick={() => window.print()} className="w-full md:w-auto bg-agro-900 hover:bg-black text-white px-10 py-4 rounded-2xl font-bold shadow-xl transition-all">
            Gerar PDF / Imprimir
          </button>
        </div>
      </div>
