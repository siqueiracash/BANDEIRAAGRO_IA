...
const ReportScreen: React.FC<ReportScreenProps> = ({ data, onReset, onReview }) => {
  return (
    <div className="w-full max-w-5xl animate-fade-in pb-10 print:pb-0">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mt-8 no-print px-4 gap-4">
        <button 
          onClick={onReset} 
          className="w-full md:w-auto text-gray-600 border-2 border-gray-300 hover:border-gray-400 px-6 py-3 rounded-lg font-bold transition-colors"
        >
          Nova Avaliação
        </button>
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
          <button 
            onClick={onReview} 
            className="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-bold shadow-md transition-colors flex items-center justify-center gap-2"
          >
          ...
          <button 
            ...
            className="w-full md:w-auto bg-agro-700 hover:bg-agro-800 text-white px-8 py-3 rounded-lg font-bold shadow-lg transition-colors flex items-center justify-center gap-2"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
